...
export class ValidateFieldsTemplateMethod {
    ...
    validate(field, value) {
        return this.#_isEmpty(value,field) && this.#_validateFieldExist(field) && this.#_validateTypeValue(field, value) && this.#_validadeLengthOfValues(field, value)
    }
    ...
    #_validateFieldExist(field) {
        ...
        if (!isValid) {
            this.mesageErrors.push(`o nome do campo é invalido`)
        }
        return isValid
    }
    ...
    #_validateTypeValue(fieldTarget, value) {
        ...
        if (!isValid) {
            this.mesageErrors.push(` o tipo do valor esperado prar '${fieldTarget}' era '${this.#typeOfSchema[fieldTarget].type}' porem recebeu o tipo '${typeof value}' `)
        }
        return isValid
    }
    ...
    #_validadeLengthOfValues(fieldTarget, value) {
        ...
        if (!isValid) {
            this.mesageErrors.push(`o tamanho minimo de ${fieldTarget} é de ${this.#typeOfSchema[fieldTarget].minLength}`)
        }
        return isValid
    }
    ...
    #_isEmpty(value,field) {
        ...
        this.mesageErrors.push(`o valor de ${field} é vazio`)
        return false
    }
